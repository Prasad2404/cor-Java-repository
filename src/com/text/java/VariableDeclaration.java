...
public class VariableDeclaration {
	...
	public static void main(String[] args) {
		...
		//way to stoer array
		int scores[]=new int[10];   // 10 indicates size of array
		
		int scores1[]= {10,20,30,40};
		
		char vovels[]= {'a','e','i','o','u'};  //way to declare char types in array
		
		float amount[]= {10.3f,90.50f}; //way to declare float types in array
